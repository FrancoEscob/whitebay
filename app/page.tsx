      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          <h1 className="max-w-xs text-2xl font-semibold leading-10 tracking-tight text-black dark:text-zinc-50">
            Editor de Prompts para IA (By FrancoEscob)
          </h1>
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          <Link
            href="/prompts"
            className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-black dark:bg-white text-white dark:text-black px-5 transition-colors hover:bg-[#383838] dark:hover:bg-[#ccc] md:w-auto"
          >
            Gestionar Prompts
          </Link>
        </div>
